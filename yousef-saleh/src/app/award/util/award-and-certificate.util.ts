...
export class AwardAndCertificateUtil {
  ...
  public static commercialCertificates: AwardAndCertificate[] = [
    { certificateId: 'cc01', certificateName: 'rcjy-logo', image: '/assets/img/awards/cc-1.jpeg' },
    { certificateId: 'cc02', certificateName: 'chamber', image: '/assets/img/awards/cc-chamber.jpeg' },
    { certificateId: 'cc03', certificateName: 'monshaat', image: '/assets/img/awards/cc-monshaat.jpeg' },
    { certificateId: 'cc04', certificateName: 'registeration', image: '/assets/img/awards/cc-registeration.jpeg' },
    { certificateId: 'cc05', certificateName: 'vat', image: '/assets/img/awards/cc-vat.jpeg' },
    { certificateId: 'cc06', certificateName: 'zakat-1', image: '/assets/img/awards/cc-zakat-1.jpeg' },
    { certificateId: 'cc06', certificateName: 'zakat', image: '/assets/img/awards/cc-zakat.jpeg' },
  ];
  ...
  public static  recognitionCertificates: AwardAndCertificate[] = [
    { certificateId: 'rc01', certificateName: 'awards-saudi-electricity', image: '/assets/img/awards/awards-saudi-electricity.jpeg' },
    { certificateId: 'rc03', certificateName: 'national-grid', image: '/assets/img/awards/COA-national-grid.jpeg' },
    { certificateId: 'rc04', certificateName: 'civil-defense', image: '/assets/img/awards/COA-civil-defense.jpeg' },
    { certificateId: 'rc05', certificateName: 'nc', image: '/assets/img/awards/COA-nc.jpeg' },
    { certificateId: 'rc06', certificateName: 'zamil', image: '/assets/img/awards/COA-zamil.jpeg' },
  ];
